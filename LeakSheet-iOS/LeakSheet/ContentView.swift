...
struct ContentView: View {
    ...
    /// The prepared view model, only when it describes the artist actually playing.
    /// Reads the singleton, not @Environment: this view installs PlayerViewModel itself.
